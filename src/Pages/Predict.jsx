...
const Predict = () => {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const response = await fetch("http://127.0.0.1:5000/predict_animal", {
        method: "POST",
        body: formData,
  ...
  return (
    <div className="h-screen w-full   bgImage">
      <div className="text-white text-4xl text-center pt-6 capitalize">
        Image Based species recognition system
      </div>
          ...
          {loading ? (
            ...
            <>
              <div className="w-[90%] flex flex-col gap-4 h-[70vh]  p-4 m-auto mt-10 rounded-md  text-white shadow-2xl">
                ...
                <div className="flex gap-2">
                  <p className="font-[600] capitalize">discovery year:</p>
                  <p className="font-[800]">
